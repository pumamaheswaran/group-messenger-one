...
public class GroupMessengerActivity extends Activity {
    ...
    private static final int[] portList = {11108,11112,11116,11120,11124};
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                ...
                try {
                    ...
                    cv.put("key",String.valueOf(++messageCount));
                    cv.put("value", sb!=null?sb.toString():null);
                    ...
                    /* Code referenced from http://developer.android.com/reference/android/os/AsyncTask.html*/
                    publishProgress(sb!=null?sb.toString():"");
                }
                catch(IOException e) {
        ...
        protected void onProgressUpdate(String...strings) {
            ...
            ((TextView) findViewById(R.id.textView1)).append("M:" + messageCount+ " " + strReceived + "\n");
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                for(Integer i : GroupMessengerActivity.portList) {
